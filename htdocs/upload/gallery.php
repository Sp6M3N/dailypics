...
foreach ($images as $image){
        echo '<button class="imgg" style="border:0px" type="button"  data-toggle="modal" data-target="#exampleModal'. $i .'" data-whatever="@mdo">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form>
          ...
          <div class="form-group">
            <label for="message-text" class="col-form-label">Ton commentaire:</label>
